            ...
            <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
                ...
                >
                    ...
                    <div className="relative mx-auto max-w-4xl">
                        ...
                        {/* Decorative elements */}
                        <div className="absolute -top-8 -right-8 w-32 h-32 bg-linear-to-br from-[#eca8d6]/20 to-transparent rounded-full blur-3xl" />
                        <div className="absolute -bottom-8 -left-8 w-32 h-32 bg-linear-to-tr from-[#67e8f9]/20 to-transparent rounded-full blur-3xl" />
                    </div>

                    {/* Features below video */}
                    <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="text-center">
                            <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-linear-to-br from-[#eca8d6] to-[#a78bfa] mb-4">
                        ...
                        <div className="text-center">
                            <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-linear-to-br from-[#a78bfa] to-[#67e8f9] mb-4">
                                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="text-center">
                            <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-linear-to-br from-[#67e8f9] to-[#fbbf24] mb-4">
                                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
