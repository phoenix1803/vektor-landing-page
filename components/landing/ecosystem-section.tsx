...
function EcosystemNode({ node }: { node: EcosystemNode }) {
  ...
  return (
    ...
    >
      ...
      {/* Node */}
      <div
        className={`relative w-24 h-24 rounded-full border-2 flex items-center justify-center transition-all duration-300 backdrop-blur-sm ${
          isHovered
      ...
      {/* Label */}
      <div
        className={`absolute -bottom-20 left-1/2 transform -translate-x-1/2 whitespace-nowrap text-center transition-all duration-300 opacity-0 pointer-events-none ${
